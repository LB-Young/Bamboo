...
Use this skill when the task needs Zhihu hot-rank data, Zhihu keyword hotspot history, or RedFoxHub aggregated top hotspot events.
...
Outputs are JSON. Treat all returned items as hotspot/rank data, not full Zhihu article or answer bodies.
