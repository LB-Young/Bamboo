...
1. `P1-04-knowledge-subagent.md`
2. `P1-06-model-fallback-and-auxiliary-router.md`
3. `P1-07-reactive-compact.md`
4. `P1-08-provider-specific-prompt.md`
5. `P1-09-agent-trace-events.md`

## P2：自动化扩展

6. `P2-02-workflow-runner.md`
7. `P2-03-cron-heartbeat.md`
